...
person_df2 <-  person_df2 <- read.csv("data/tidynomicon/person.csv", stringsAsFactors=FALSE)
str(person_df2)
...
voter_turnout_df2 <-  read_excel("data/G04resultsdetail2004-11-02.xls", sheet=2, skip=2, col_names=c("ward_precinct", "ballots_cast", "registered_voters", "voter_turnout"))
